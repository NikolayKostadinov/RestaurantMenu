  ...
  return (
    <section className="transparent">
      <div className="overlay">
        <div className="container raise-2 dark-overlay">
          <h6 className="section-subtitle text-center">Ароматни <span className="text-primary font-weight-bold">&amp;</span> Сочни</h6>
          <h3 className="section-title mb-6 pb-3 text-center">Основни ястия</h3>
          <div className="row">
