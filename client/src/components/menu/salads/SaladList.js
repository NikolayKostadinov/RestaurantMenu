const SaladList = () => {
    return(
    <section className="pattern-style-4 has-overlay">
      <div className="container raise-2">
        <h6 className="section-subtitle text-center">Свежи <span className="text-primary font-weight-bold">&amp;</span> Вкусни</h6>
        <h3 className="section-title mb-6 pb-3 text-center">Салати</h3>
        <div className="row">
